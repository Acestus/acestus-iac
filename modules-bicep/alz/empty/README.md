# Acestus ALZ Empty Module

This is a custom Bicep module for Azure ALZ Empty that implements Acestus security standards and naming conventions.
...
|-----------|------|-------------|
| `name` | string | ALZ Empty resource name |
...
|--------|------|-------------|
| `resourceId` | string | ALZ Empty resource ID |
| `resourceName` | string | ALZ Empty resource name |
