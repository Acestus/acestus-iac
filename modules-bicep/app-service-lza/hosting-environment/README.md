# Acestus App Service LZA Hosting Environment Module

This is a custom Bicep module for Azure App Service LZA Hosting Environment that implements Acestus security standards and naming conventions.
...
|-----------|------|-------------|
| `name` | string | Hosting Environment resource name |
...
### Basic Hosting Environment Resource
```bicep
...
|--------|------|-------------|
| `resourceId` | string | Hosting Environment resource ID |
| `resourceName` | string | Hosting Environment resource name |
