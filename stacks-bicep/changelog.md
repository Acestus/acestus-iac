...
- **Resource Group**: `rg-identity-cus-001`
...
### Resource Naming
**Identity Resources:**
- App Service Plan: `asp-idnt-prd-cus-001`
- Application Insights: `ai-idnt-prd-cus-001`
- Storage Account: `stidntprdcus001`
- Function App: `func-idnt-alert-prd-cus-001`
- Action Groups: `ag-idnt-email-cus-001`, `ag-idnt-teams-cus-001`

**EDM Resources:**
- App Service Plan: `asp-edm-prd-cus-001`
- Application Insights: `ai-edm-prd-cus-001`  
- Storage Account: `stedmprdcus001`
- Function App: `func-edm-alert-prd-cus-001`
- Action Groups: `ag-edm-email-cus-001`, `ag-edm-teams-cus-001`

### Deployment Scripts
- Updated to use `az stack sub create` for subscription-level deployments
- Modified stack names: `stack-identity-cus-001` and `stack-edm-cus-001`
...
```powershell
cd "<your-repo-path>\bicep-infra\rg-acestus-idnt-cus-001"
.\deploy-bicep-stack.ps1 -StackName "stack-identity-cus-001" -SubscriptionId "c06072ff-5e1d-48ae-9d1a-cea0834bc1aa"
```

### Deploy EDM Resources  
```powershell
cd "<your-repo-path>\bicep-infra\rg-acestus-edm-cus-001"
.\deploy-bicep-stack.ps1 -StackName "stack-edm-cus-001" -SubscriptionId "8b67b073-f765-482f-82ad-ede639aef462"
```
...
2. **Create Log Analytics Workspaces**: Verify these exist or update the workspace resource IDs in the parameter files:
   - Identity: `/subscriptions/<subscription-id>/resourceGroups/rg-identity-monitoring/providers/Microsoft.OperationalInsights/workspaces/law-identity-cus`
   - EDM: `/subscriptions/<subscription-id>/resourceGroups/rg-edm-monitoring/providers/Microsoft.OperationalInsights/workspaces/law-edm-cus`
...
### Identity (rg-acestus-idnt-cus-001)
